...
fun Canvas.drawLineBentArcRight(w : Float, h : Float, scale : Float, paint : Paint) {
...
fun Canvas.drawLBARNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBentArcRight(w, h, scale, paint)
}
...
class LineBentArcRightView(ctx : Context) : View(ctx) {
    ...
    companion object {
        fun create(activity : Activity) :LineBentArcRightView {
            val view : LineBentArcRightView = LineBentArcRightView(activity)
