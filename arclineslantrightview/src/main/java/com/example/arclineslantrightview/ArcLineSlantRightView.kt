package com.example.arclineslantrightview
...
fun Canvas.drawArcLineSlantRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawALSRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawArcLineSlantRight(scale, w, h, paint)
}

class ArcLineSlantRightView(ctx : Context) : View(ctx) {
    ...
    data class ArcLineSlantRight(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity: Activity) : ArcLineSlantRightView {
            val view : ArcLineSlantRightView = ArcLineSlantRightView(activity)
