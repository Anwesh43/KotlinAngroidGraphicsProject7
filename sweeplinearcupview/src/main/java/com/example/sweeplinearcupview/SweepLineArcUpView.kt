package com.example.sweeplinearcupview
...
fun Canvas.drawSweepLineArcUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawSLAUNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawSweepLineArcUp(scale, w, h, paint)
}

class SweepLineArcUpView(ctx : Context) : View(ctx) {
    ...
    data class SweepLineArcUp(var i : Int) {

        private var curr : SLAUNode = SLAUNode(0)
