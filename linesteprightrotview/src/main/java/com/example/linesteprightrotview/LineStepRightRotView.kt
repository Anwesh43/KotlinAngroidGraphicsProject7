package com.example.linesteprightrotview
...
fun Canvas.drawLSRRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineStepRightRot(scale, w, h, paint)
}

class LineStepRightRotView(ctx : Context) : View(ctx) {
    ...
    data class LineStepRightRot(var i : Int) {
