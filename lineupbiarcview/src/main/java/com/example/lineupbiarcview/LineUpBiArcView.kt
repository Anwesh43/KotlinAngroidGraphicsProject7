package com.example.lineupbiarcview
...
fun Canvas.drawLineUpBiArc(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLUBANode(i : Int, scale : Float, paint : Paint) {
...
class LineUpBiArcView(ctx : Context) : View(ctx) {
    ...
    data class LUBANode(var i : Int = 0, val state : State = State()) {

        private var next : LUBANode? = null
        private var prev : LUBANode? = null
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawLUBANode(i, state.scale, paint)
        }
        ...
        fun getNext(dir : Int, cb : () -> Unit) : LUBANode {
            var curr : LUBANode? = prev
            if (dir === 1) {
                curr = next
            }
            if (curr != null) {
    ...
    data class LineUpBiArc(var i : Int) {

        private var curr : LUBANode = LUBANode(0)
