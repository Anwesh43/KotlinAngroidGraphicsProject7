...
class QuarterArcJoinView(ctx : Context) : View(ctx) {
    ...
    data class QuarterArcJoin(var i : Int) {

        private var curr : QAJNode = QAJNode(0)
    ...
    companion object {
        fun create(activity: Activity) : QuarterArcJoinView {
            val view : QuarterArcJoinView = QuarterArcJoinView(activity)
