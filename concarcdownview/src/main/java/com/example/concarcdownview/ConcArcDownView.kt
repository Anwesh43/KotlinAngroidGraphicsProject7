package com.example.concarcdownview
...
class ConcArcDownView(ctx : Context) : View(ctx) {
    ...
    data class CADNode(var i : Int = 0, val state : State = State()) {
    ...
    data class ConcArcDown(var i : Int) {

        private var curr : CADNode = CADNode(0)
    ...
    data class Renderer(var view : ConcArcDownView) {

        private val animator : Animator = Animator(view)
        private val paint : Paint = Paint(Paint.ANTI_ALIAS_FLAG)
        private val cad : ConcArcDown = ConcArcDown(0)
    ...
    companion object {
        fun create(activity: Activity) : ConcArcDownView {
            val view : ConcArcDownView = ConcArcDownView(activity)
