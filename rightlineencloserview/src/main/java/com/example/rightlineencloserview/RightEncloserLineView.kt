package com.example.rightlineencloserview
...
fun Canvas.drawRightEncloserLine(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawRELNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawRightEncloserLine(scale, w, h, paint)
}

class RightEncloserLineView(ctx : Context) : View(ctx) {
    ...
    data class RELNode(var i : Int = 0, val state : State = State()) {
    ...
    data class RightEncloserLine(var i : Int) {
