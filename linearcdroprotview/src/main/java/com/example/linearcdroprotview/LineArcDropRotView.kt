package com.example.linearcdroprotview
...
fun Canvas.drawLineArcDropRot(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLADRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineArcDropRot(scale, w, h, paint)
}

class LineArcDropRotView(ctx : Context) : View(ctx) {
    ...
    data class LineArcDropRot(var i : Int) {
    ...
    data class Renderer(var view : LineArcDropRotView) {

        private val animator : Animator = Animator(view)
        private val ladr : LineArcDropRot = LineArcDropRot(0)
