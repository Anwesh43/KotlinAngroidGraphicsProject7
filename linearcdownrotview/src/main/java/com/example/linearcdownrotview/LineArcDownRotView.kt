package com.example.linearcdownrotview
...
fun Canvas.drawLineArcDownRot(scale : Float, w : Float, h : Float, paint : Paint) {
    ...
    drawXY(w / 2 + (w / 2) * dsc(4), h / 2) {
        ...
        drawXY(0f, -size * (1 - dsc(2))) {
            ...
            drawLine(0f, 0f, 0f, size * (dsc(1) - dsc(2)), paint)
        }
    }
}
...
fun Canvas.drawLADRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineArcDownRot(scale, w, h, paint)
}

class LineArcDownRotView(ctx : Context) : View(ctx) {
    ...
    data class LineArcDownRot(var i : Int) {
