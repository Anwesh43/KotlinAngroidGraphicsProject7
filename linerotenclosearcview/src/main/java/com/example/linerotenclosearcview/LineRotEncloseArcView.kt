package com.example.linerotenclosearcview
...
fun Canvas.drawLineRotEncloseArc(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLREANode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineRotEncloseArc(scale, w, h, paint)
}

class LineRotEncloseArcView(ctx : Context) : View(ctx) {
    ...
    data class LREANode(var i : Int = 0, val state : State = State()) {
    ...
    data class LineRotEncloseArc(var i : Int) {
